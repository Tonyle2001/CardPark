...
LotIModel.prototype.setOccupied = function(index) {
...
LotIModel.prototype._startTimeout = function(index, delay) {
    setTimeout(() => {
...
LotIModel.prototype._commit = function() {
    localStorage.setItem('parkingSpots', JSON.stringify(this.spots));
};

LotIModel.prototype.restoreState = function() {
